...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            <div class="small-box" style="background-color:#6b0a0acc !important">
                <div class="inner">
                    <h3 class="text-light">{{ $kandidat }}</h3>
                    <p class="text-light">Kandidat</p>
                </div>
                <div class="icon">
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: votes,
                            borderWidth: 1,
                            backgroundColor: ["#6b0a0acc", "#FFC107"]
                        }]
                    },
                    options: {
